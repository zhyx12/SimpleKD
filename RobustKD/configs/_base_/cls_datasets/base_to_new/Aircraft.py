...
source_domain = 'base2new_Aircraft'
target_domain = 'base2new_Aircraft'
...
test_pipelines = [
    dict(type='LoadImageFromFile'),
    dict(type='Resize', size=256, backend='pillow', interpolation='nearest'),  # test size 256
...
target_test_datasets_new = dict(
    ...
    split='testnew',
    pipeline=test_pipelines,
    label_transform=list(range(50, 100)),
    builder=dict(
        samples_per_gpu=128,
    )
)
