_base_ = [
    '../_base_/cls_datasets/base_to_new/EuroSAT.py',
...
train = dict(
    ...
    lambda_instance_relation=0.0,
    fusion_type_in_instance_relation=None,
)

test = dict(
    custom_hooks=[
        dict(type='ClsAccuracy', dataset_index=0, pred_key='pred', class_acc=True, num_class=5),
        dict(type='ClsAccuracy', dataset_index=1, pred_key='pred', class_acc=True, num_class=5),
