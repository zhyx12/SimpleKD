_base_ = [
    '../_base_/cls_datasets/base_to_new/Flowers102_resized_crop.py',
...
test = dict(
    custom_hooks=[
        dict(type='ClsAccuracy', dataset_index=0, pred_key='pred', class_acc=True, num_class=51),
        dict(type='ClsAccuracy', dataset_index=1, pred_key='pred', class_acc=True, num_class=51),
