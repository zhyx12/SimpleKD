_base_ = [
    '../_base_/cls_datasets/base_to_new/SUN397.py',
...
train = dict(
    ...
    base_class_list=list(range(199)),
...
test = dict(
    custom_hooks=[
        dict(type='ClsAccuracy', dataset_index=0, pred_key='pred', class_acc=True, num_class=199),
        dict(type='ClsAccuracy', dataset_index=1, pred_key='pred', class_acc=True, num_class=198),
